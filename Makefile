...
ft_putendl_fd.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_putnbr_fd.c ft_itoa.c ft_strmapi.c ft_striteri.c \
ft_itoa.c ft_strnstr.c ft_strlcat.c ft_striteri.c ft_split.c
