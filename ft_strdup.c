...
/*   Updated: 2023/04/24 14:33:36 by fpulin-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
We add 1 to len because the ft_srtlen function that we use just goes up to une
position before theend of the string '\0'. When we use the term sizeof(char)
